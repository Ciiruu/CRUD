...
<div class="content read">
    <h2>Pengiriman</h2>
    <a href="create.php" class="create-contact">Tambah Pengiriman</a>
    <table>
        <thead>
            <tr>
                <td>#</td>
        ...
        <tbody>
            <?php foreach ($contacts as $contact) : ?>
                <tr>
                    <td><?= $contact['id'] ?></td>
                    <td><?= $contact['nama_pengirim'] ?></td>
                    <td><?= $contact['alamat_pg'] ?></td>
                    <td><?= $contact['nama_penerima'] ?></td>
                    <td><?= $contact['alamat_pn'] ?></td>
                    <td><?= $contact['berat_barang'] ?></td>
